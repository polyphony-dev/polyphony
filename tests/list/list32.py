...
def list32_a_func(buf0:list, buf1:list):
    ref0 = buf0
    ref1 = buf1
...
def list32_b_func(buf0:list, buf1:list):
    ref0 = buf1  # dead code
    ref1 = buf0  # dead code
    for i in range(len(buf0)):
        if i % 2 == 0:
...
def list32_c_func(buf0:list, buf1:list):
    ref0 = buf0
    ref1 = buf1
    for i in range(len(buf0)):
        ref0[i] = i + 1
